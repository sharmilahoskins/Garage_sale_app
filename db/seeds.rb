...
sale = Sale.create!(street: '13162 Capstone Drive', city: 'San Diego', state: 'California', zip: '92130', date: '08/24/2017', time: "8-11am", description: 'Moving soon and everything must go.', user_id: user.id )
...
sale = Sale.create!(street: '704 J Street', city: 'San Diego', state: 'California', zip: '92101', date: '09/15/2017', time: "9-noon", description: 'Power tools and more!', user_id: user.id )
...
sale = Sale.create!(street: '4711 Timberline Drive', city: 'Austin', state: 'Texas', zip: '78746', date: '09/15/2017', time: "7-10am",  description: 'Furniture, clothes and more!', user_id: user.id )
...
sale = Sale.create!(street: '1533 S Main Street', city: 'Winston-Salem', state: 'North Carolina', zip: '27127', date: '09/15/2017', time: "2-4pm", description: 'Cute clothes and other items', user_id: user.id )
...
sale = Sale.create!(street: '22 Merrill Rd', city: 'Freeport', state: 'Maine', zip: '04032', date: '08/26/2017', time: '9-noon', description: 'Sports equipment, golf clubs and more', user_id: user.id )
