...
sale = Sale.create!(street: '13162 Capstone Drive', city: 'San Diego', state: 'California', zip: '92130', date: '08/24/2017', description: 'Moving soon and everything must go.', user_id: user.id )

item = Item.new(item_name: 'Shoes', item_description: 'Barely used brown Dansko clogs', price: '$25', sale_id: sale.id)
item.image = File.open("/Users/amydyson/Desktop/SeedFileImages/dankso.jpg")
item.save

item = Item.new(item_name: 'Shoes', item_description: 'Gucci mules', price: '$99', sale_id: sale.id)
item.image = File.open("/Users/amydyson/Desktop/SeedFileImages/gucciShoes.jpg")
item.save
...
sale = Sale.create!(street: '704 J Street', city: 'San Diego', state: 'California', zip: '92101', date: '09/15/2017', description: 'Power tools and more!', user_id: user.id )


item = Item.new(item_name: 'Saw', item_description: 'Power saw from Home Depot', price: '$60', sale_id: sale.id)
item.image = File.open("/Users/amydyson/Desktop/SeedFileImages/saw.jpg")
item.save

item = Item.new(item_name: 'Sander', item_description: 'Deck XP', price: '$75', sale_id: sale.id)
item.image = File.open("/Users/amydyson/Desktop/SeedFileImages/sander.jpg")
item.save


item = Item.new(item_name: 'Comfy chair', item_description: 'Plush red chair', price: '$105', sale_id: sale.id)
item.image = File.open("/Users/amydyson/Desktop/SeedFileImages/redchair.jpg")
item.save
...
sale = Sale.create!(street: '4711 Timberline Drive', city: 'Austin', state: 'Texas', zip: '78746', date: '09/15/2017', description: 'Furniture, clothes and more!', user_id: user.id )
...
item.image = File.open("/Users/amydyson/Desktop/SeedFileImages/couchsectional.jpg")
item.save
