...
sale.street = "#{sale.street}, #{sale.city}, #{sale.state}"
sale.save
>>>>>>> 6592b149d2530b95b6040a2d490ddda47d8310fd
...
sale = Sale.create(street: '345 F Street Ste 175', city: 'San Diego', state: 'California', zip: '91910', date: "2018-11-14", time: "2-4pm", description: 'Couch, patio furniture, cute clothes and other items', user_id: user.id )
sale.street = "#{sale.street}, #{sale.city}, #{sale.state}"
sale.save
...
sale = Sale.create(street: '215 South St. Andrews Place', city: 'Los Angeles', state: 'California', zip: '90004', date: "2018-09-25", time: "9-noon", description: 'Power tools and more!', user_id: user.id )
sale.street = "#{sale.street}, #{sale.city}, #{sale.state}"
sale.save
...
sale = Sale.create(street: '200 South Grand Avenue', city: 'Los Angeles', state: 'California', zip: '90012', date: "2018-11-14", time: "2-4pm", description: 'Couch, patio furniture, cute clothes and other items', user_id: user.id )
sale.street = "#{sale.street}, #{sale.city}, #{sale.state}"
sale.save
